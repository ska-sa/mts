...
\n"
    ...
    # Add CTS extensions to parent class
...
if __name__ == '__main__':
    ...
    # CTS uses only one of the available synthesizers (currently SYNTH 2)
    synth = CTSvalon(valon_synth.SYNTH_B, opts.tty, restore=opts.restore)
